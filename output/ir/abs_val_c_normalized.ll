; ModuleID = '/tmp/equivalence_checker/abs_val_c_normalized.bc'
source_filename = "/tmp/equivalence_checker/abs_val_c_harness.c"
...
define dso_local i32 @abs_val(i32 noundef %0) #0 {
  %2 = icmp slt i32 %0, 0
...
7:                                                ; preds = %4, %0
  ...
  %12 = call i32 @abs_val(i32 noundef %11)
  ret i32 %12
}
