; ModuleID = '/tmp/equivalence_checker/abs_val_rust_normalized.bc'
...
bb6:                                              ; preds = %bb5, %bb4
  ...
  %2 = call i32 @_ZN20abs_val_rust_harness7abs_val17h394ad44c157288efE(i32 %_17)
  ret i32 %2
}
