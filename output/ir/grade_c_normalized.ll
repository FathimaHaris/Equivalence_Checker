; ModuleID = '/tmp/equivalence_checker/grade_c_opt_display.bc'
source_filename = "/tmp/equivalence_checker/grade_c_harness.c"
...
define dso_local i32 @grade(i32 noundef %0) #0 {
  %2 = icmp sge i32 %0, 90
...
8:                                                ; preds = %5, %0
  ...
  %13 = call i32 @grade(i32 noundef %12)
