; ModuleID = 'compute_rust_harness.bce71cb4-cgu.0'
...
; call compute_rust_harness::compute
  %6 = call i32 @_ZN20compute_rust_harness7compute17h62be4aa0f57f4409E(i32 %_33, i32 %_34)
  ret i32 %6
}
